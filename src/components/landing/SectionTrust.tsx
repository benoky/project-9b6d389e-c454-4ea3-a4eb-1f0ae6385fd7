  ...
  return <section className="section-padding bg-background">
      <div className="container-tight">
        ...
        duration: 0.5
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto text-balance leading-relaxed">에너지 운영 최적화·절감·신재생 도입까지, 
공공/민간 현장에서 검증된 방식으로 지원합니다.</p>
        </motion.div>
        ...
        <div className="relative overflow-hidden py-8 mb-10">
          ...
          <div className="flex animate-marquee">
            {[...partners, ...partners].map((partner, index) => <div key={`${partner.name}-${index}`} className="flex-shrink-0 mx-3 md:mx-4">
                <div className="h-14 md:h-16 min-w-[140px] md:min-w-[160px] flex items-center justify-center px-4 py-3 bg-white rounded-2xl border border-border/30 shadow-sm">
